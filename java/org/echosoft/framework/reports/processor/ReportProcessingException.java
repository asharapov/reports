...
public class ReportProcessingException extends Exception {
    ...
    public ReportProcessingException(String message, ExecutionContext ctx) {
        super(message);
        this.ctx = ctx;
    }

    public ReportProcessingException(String message, Throwable cause, ExecutionContext ctx) {
        super(message, cause);
        this.ctx = ctx;
    }
