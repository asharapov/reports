...
public enum ProviderUsage {
     ...
     *  когда у них есть дочерние секции подключенные к тому же курсору данных посредством использования т.н. логических источников данных - {@link org.echosoft.framework.reports.model.providers.FilteredDataProviderHolder}.
     * </p>
     */
    STANDARD,
     ...
     * посредством т.н. логических источников данных {@link org.echosoft.framework.reports.model.providers.FilteredDataProviderHolder}.
